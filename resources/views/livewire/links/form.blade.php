<div class="p-4 space-y-6 rounded-lg border-2">
    ...
    <x-input.group for="title" label="Title" width="full">
        <x-input.text wire:model.live='title' type="text" class="form-input w-full rounded" value="{{$title}}">
        </x-input.text>
    </x-input.group>

    <!-- link URL -->
    <x-input.group for="url" label="URL" width="full">
        <x-input.text wire:model.live='url' type="text" class="form-input w-full rounded" value="{{$url}}">
        </x-input.text>
    </x-input.group>
    ...
    <div class="flex flex-row justify-between">
            ...
            <x-input.group for="position" label="Position" >
                <x-input.text wire:model.live='position' type="text" class="form-input w-full rounded" value="{{$position}}">
                </x-input.text>
            </x-input.group>
